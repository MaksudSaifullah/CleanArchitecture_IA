...
{
    public partial class GetAmbsDataSyncRiskAssesmentSPupdate : Migration
    {
...
DECLARE @datarequestServiceId nvarchar(max)
...
isnull(y.Text,x.Text)Text,
isnull(y.IsDraft,x.IsDraft)IsDraft,
x.TC FROM(select @datarequestServiceId as [DataRequestQueueServiceId],b.BranchCode,b.BranchId,b.BranchName,0 as Amount, 0 as AmountConverted,z.Score as Score,p.Text as Text,@CountryId as CountryId,
...
select @datarequestServiceId as [DataRequestQueueServiceId],b.BranchCode,b.BranchId,b.BranchName,0 as Amount, 0 as AmountConverted,z.Score as Score,p.Text as Text,@CountryId as CountryId,
1  as isDraft,@totalcount as TC
from 
security.Branch b
inner join [BranchAudit].[RiskCriteria] z
...
select @datarequestServiceId as DataRequestServiceId,b.BranchCode,b.BranchId,b.BranchName,0 as Amount, 0 as ConvertedAmount,0 as Score,'NA' as Text,@CountryId as CountryId,1  as isDraft,@totalcount as TC from 
security.Branch b
where b.CountryId=@CountryId
...
isnull(y.Text,x.Text)Text,
isnull(y.IsDraft,x.IsDraft)IsDraft,
x.TC from(select @datarequestServiceId as [DataRequestQueueServiceId],b.BranchCode,b.BranchId,b.BranchName,0 as Amount, 0 as AmountConverted,0 as Score,'NA' as Text,@CountryId as CountryId,1  as isDraft,@totalcount as TC from 
security.Branch b
where b.CountryId=@CountryId
)x
left join (
