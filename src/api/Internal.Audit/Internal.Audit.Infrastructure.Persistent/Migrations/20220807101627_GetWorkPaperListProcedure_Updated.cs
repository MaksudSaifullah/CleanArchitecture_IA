...
{
    public partial class GetWorkPaperListProcedure_Updated : Migration
    {
...
SELECT wp.[Id]
	  ...
	  ,tstcl.Text As TestingConclusion
      ,wp.[DocumentId]
  ...
  Inner Join Config.CommonValueAndType tstcl on wp.SampleSizeId = tstcl.Id
