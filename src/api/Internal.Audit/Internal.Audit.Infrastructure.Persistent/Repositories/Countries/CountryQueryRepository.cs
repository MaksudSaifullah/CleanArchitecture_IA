...
namespace Internal.Audit.Infrastructure.Persistent.Repositories.Countries
{
    public class CountryQueryRepository : QueryRepositoryBase<Country>, ICountryQueryRepository
    {
        ...
        public async Task<(long, IEnumerable<Country>)> GetAll(int pageSize, int pageNumber, dynamic searchTerm = null)
        {
            ...
            var query = "EXEC [dbo].[GetCountryListProcedure] @pageSize,@pageNumber,@searchTerm";
