...
export class HelperService {
  ...
  async getDocumentSource(type: any): Promise<any> {    
    let x = await firstValueFrom(this.http.get('DocumentSource')) as DocumentSource[];
    let filteredData = x.find((obj) => {
