...
{
    public partial class AMBSDATASYNCSPUPDATE : Migration
    {
...
FETCH NEXT case when @pageSize=-1 THEN case when @totalcount=0 then 1 else 0 end  else @pageSize end  ROWS ONLY;
