...
{
    public partial class GetAuditScheduleListProcedureupdated : Migration
    {
...
SELECT a.Id, c.Name Country,a.ScheduleId,
(SELECT
	STUFF((SELECT ', ' + CAST(y.UserName AS nVARCHAR(max)) 
	FROM [BranchAudit].[AuditScheduleParticipants] x
	INNER JOIN [security].[User]  y on x.UserId=y.Id
...
GROUP BY a.Id,u.Id,c.Name,u.UserName,a.ScheduleEndDate,a.ScheduleStartDate,a.CreatedOn,a.ScheduleId
